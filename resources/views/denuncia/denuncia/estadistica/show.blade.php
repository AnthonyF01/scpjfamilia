...
<head>
  ...
  <style>
    /*@page { margin-top: 10px; margin-bottom: 50px; margin-left: 50px; margin-right: 50px; border: 1px solid #ccc}*/
    @page { margin-top: 150px; margin-bottom: 50px; margin-left: 50px; margin-right: 50px; border: 1px solid #ccc}
    #header { position: fixed; left: 0px; top: -145px; right: 0px; height: 80px; text-align: center; }
