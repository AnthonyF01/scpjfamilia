    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="box_plus box_plus-default ">
        <div id="box_plus-title" class="box_plus-heading">
        	@if(isset($tblmotivo) && !empty($tblmotivo['id']))
        		Editar Motivo
	        @else
        		Crear Motivo
	        @endif
        ...
        <div class="box_plus-body">
        	...
        	@if(isset($tblmotivo) && !empty($tblmotivo['id']))
          	{!! Form::model($tblmotivo, [ 'route' => ['motivo.update', $tblmotivo->id], 'method' => 'PUT', 'id'=>'form_motivo' ]) !!}
	        @else
	          {!! Form::open([ 'route' => 'motivo.store', 'id'=>'form_motivo' ]) !!}
          @endif
            ...
            <div class="form-group">
              ...
              <span id="error-tbldistrito_id" class="invalid-feedback"></span>
						...
						<div class="form-group">
							...
							@endif
							<a href="javascript:ajaxLoad('{{ url('/tblmotivo') }}')" class="btn btn-default pull-right">Cancelar</a>
						</div>
