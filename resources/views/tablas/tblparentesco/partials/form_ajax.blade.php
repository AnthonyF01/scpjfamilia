    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="box_plus box_plus-default ">
        <div id="box_plus-title" class="box_plus-heading">
        	@if(isset($tblparentesco) && !empty($tblparentesco['id']))
        		Editar Parentesco
	        @else
        		Crear Parentesco
	        @endif
        ...
        <div class="box_plus-body">
        	...
        	@if(isset($tblparentesco) && !empty($tblparentesco['id']))
          	{!! Form::model($tblparentesco, [ 'route' => ['parentesco.update', $tblparentesco->id], 'method' => 'PUT', 'id'=>'form_parentesco' ]) !!}
	        @else
	          {!! Form::open([ 'route' => 'parentesco.store', 'id'=>'form_parentesco' ]) !!}
          @endif
            ...
            <div class="form-group">
              ...
              <span id="error-tbldistrito_id" class="invalid-feedback"></span>
						...
						<div class="form-group">
							@if( !empty($tblparentesco['id']) ) 
								{!! Form::button("Actualizar",["type" => "submit","class"=>"btn btn-warning"])!!}
							@else
								{!! Form::button("Guardar",["type" => "submit","class"=>"btn btn-primary"])!!}
							@endif
							<a href="javascript:ajaxLoad('{{ url('/tblparentesco') }}')" class="btn btn-default pull-right">Cancelar</a>
						</div>
